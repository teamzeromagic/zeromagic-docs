...
If your base URL is `https://magic.zeromagic.cloud/` and your App ID is `a561a95719d24f46b0640f3b342f891e`, you want to deploy to the `staging` environment, and your API path is `user-management/`, your API will be accessible at:

```jsx REST AUTH
https://magic.zeromagic.cloud/auth/a561a95719d24f46b0640f3b342f891e/staging/user-management/
```

```jsx REST APP
https://magic.zeromagic.cloud/api/a561a95719d24f46b0640f3b342f891e/staging/user-management/
```

```jsx GRAPHQL
https://magic.zeromagic.cloud/a561a95719d24f46b0640f3b342f891e/staging/user-management/graphql
```

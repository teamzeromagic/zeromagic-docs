...
- Navigate to the Flow Builder page of your desired RestAPI module.

- Click on `Magic AI` located in the top left corner of the page. This will open field to input your prompt. 

![magic-ai-button](/assets/images/magic-ai-button.png)


- Type a descriptive prompt that outlines the functionality of the REST API you want to generate.

![magic-ai-restapi](/assets/images/magic-ai-restapi.png)

> Example: "Create a REST API to get all records."

- After entering your prompt, press `Enter` button. The Flow Generator will process your prompt and automatically create a REST API flow in the flow builder.

- The generated REST API flow will be displayed in the API list. The flow builder allows you to modify the generated API flow. Add, remove, or adjust nodes to fine-tune the API’s behavior. Modify request and response schemas, authentication methods, and other configurations as needed.

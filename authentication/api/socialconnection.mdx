...
Make sure to configure the below given call back URL in the third party service `https://auth.zeromagic.in/oauth/callback/`
</Note>
...
For example, if your client_oauth_redirect_uri is **https://client.zeromagic.in/** then success response will be in the format of

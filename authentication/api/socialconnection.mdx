...
Make sure to configure the below given call back URL in the third party service `https://auth.zeromagic.cloud/oauth/callback/`
</Note>
...
```jsx Request
POST https://api.zeromagic.cloud/auth/353d1499ab5149e194a53cf0f6c837f4/development/oauth 
HTTP/1.1

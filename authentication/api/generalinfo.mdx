...
For example, if 
```jsx
https://api.zeromagic.in/auth/353d1499ab5149e194a53cf0f6c837f4/development/
```
 is your authentication base url and you have to make a request to `/email-password-signup` endpoint, then your uri will be

```jsx
https://api.zeromagic.in/auth/353d1499ab5149e194a53cf0f6c837f4/development/email-password-signup
```

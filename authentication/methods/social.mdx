...
- Add the Callback Url in your third party developer application. Get the [Oauth Callback Url here](/authentication/methods/social#oauth-callback-url)


![connection-google](/assets/images/connection-google.png)
...
<Note>
Callback url : `https://auth.zeromagic.in/oauth/callback/`
</Note>

...
![discount-api](/assets/blogs/decision-making-with-if-else-conditions-in-workflows/discount-api.png)

2. Using an if-else, evaluate the combined condition to check if the combined criteria are met.

![discount-condition](/assets/blogs/decision-making-with-if-else-conditions-in-workflows/discount-condition.png)
...
```
![discount-flow](/assets/blogs/decision-making-with-if-else-conditions-in-workflows/discount-flow.png)

5. Click `Deploy` to update the flow and to utilise your API.

![discount-sucess](/assets/blogs/decision-making-with-if-else-conditions-in-workflows/discount-sucess.png)

...
![forloop](/assets/blogs/learn-to-use-for-loops-in-workflows/forloop.png)

### Step 2: For Loop Block

Add a `For Loop Block` to the workflow and declare start, stop and step value.
![for-loop-var](/assets/blogs/learn-to-use-for-loops-in-workflows/for-loop-var.png)
...
![var-block](/assets/blogs/learn-to-use-for-loops-in-workflows/var-block.png)
...
![even-sum](/assets/blogs/learn-to-use-for-loops-in-workflows/even-sum.png)
...
![json-block](/assets/blogs/learn-to-use-for-loops-in-workflows/json-block.png)
...
![forloop-workflow](/assets/blogs/learn-to-use-for-loops-in-workflows/forloop-workflow.png)

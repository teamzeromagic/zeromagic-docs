...
![db-section](/assets/blogs/connect-your-azure-cosmos-db-to-zeromagic-in-minutes/db-section.png)
...
![cosmos-db-name](/assets/images/cosmos-db-name.png)
...
![cosmos-config](/assets/images/cosmos-config.png)
...
![cosmos-ext-db](/assets/images/create-ext-db.png)
...
![cosmos-ext-db-conn](/assets/blogs/connect-your-azure-cosmos-db-to-zeromagic-in-minutes/ext-db.png)
